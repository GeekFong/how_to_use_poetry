...
echo Adding %%APPDATA%%\pypoetry\venv\Scripts to PATH...
...
REM 检查是否已经包含相同的路径
set "NEW_PATH=!CURRENT_PATH!;%APPDATA%\pypoetry\venv\Scripts"
echo !CURRENT_PATH! | findstr /i /c:"%APPDATA%\pypoetry\venv\Scripts" > nul
if not errorlevel 1 (
